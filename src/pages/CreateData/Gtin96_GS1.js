...
const Gtin96_GS1 = () => {
  ...
  return (
    <div className='container ps-0' >
      <div className='pb-3'>
        <h3 className='text-center pt-3 pb-1'>Gtin96 - GS1</h3>
      </div>
            ...
            <Card className="shadow-lg mb-4" style={{ width: '100%', borderRadius: '10px', overflow: 'hidden' }}>
              <Card.Body className="p-3">
                ...
                <Card.Text className="text-muted mb-3">
                  <strong>Loại Data:</strong> Gtin96 - GS1
                </Card.Text>
                <Button variant="outline-secondary" className="w-100" onClick={handleShow}>Xem chi tiết</Button>
                {show && <PopUpGtin96_GS1 handleShow={handleShow} handleClose={handleClose}/>}
              </Card.Body>
            </Card>
          </Col>
        </Row>
